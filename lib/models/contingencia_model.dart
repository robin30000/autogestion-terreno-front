...
NewReponseContingencia newReponseContingenciaFromJson(String str) => NewReponseContingencia.fromJson(json.decode(str));

String newReponseContingenciaToJson(NewReponseContingencia data) => json.encode(data.toJson());
...
class NewReponseContingencia {
    ...
    String type;
    List<Contingencia> contingencia;

    factory NewReponseContingencia.fromJson(Map<String, dynamic> json) => NewReponseContingencia(
        type: json["type"],
        contingencia: List<Contingencia>.from(json["message"].map((x) => Contingencia.fromJson(x))),
    );
...
class Contingencia {
    ...
    factory Contingencia.fromJson(Map<String, dynamic> json) => Contingencia(
        id: json["id"],
        accion: json["accion"],
        ciudad: json["ciudad"],
        ...
        horacontingencia: json["horacontingencia"] == null ? '' : DateTime.parse(json["horacontingencia"]),
