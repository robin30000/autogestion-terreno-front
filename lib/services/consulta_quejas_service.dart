...
class ConsultaQuejasService extends ChangeNotifier {
  ...
  Future<List?> getQueja({
    ...
    try {
      ...
      final url = Uri.http(_baseUrl, '/autogestionterreno-dev/getQuejas', {
        'pedido': pedido,
      });
  ...
  Future<Map?> postQuejaGo(
    ...
    try {
      ...
      final url = Uri.http(_baseUrl, '/autogestionterreno-dev/postquejago');
  ...
  getQuejasGoByUser() async {
    try {
      ...
      final url =
          Uri.http(_baseUrl, '/autogestionterreno-dev/getquejasgobyuser');
