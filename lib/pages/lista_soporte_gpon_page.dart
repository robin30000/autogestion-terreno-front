...
class ListSoporteGponPage extends StatefulWidget {
  const ListSoporteGponPage({super.key});

  @override
  State<ListSoporteGponPage> createState() => _ListSoporteGponPageState();
}

class _ListSoporteGponPageState extends State<ListSoporteGponPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: soportegponService.isLoading ?
        SizedBox(
          width: mq.width * 1,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: mq.width,
                    height: mq.height * 0.75,
                    child:soportegponService.soportegpon.isEmpty 
                    ? const Center(
                      child: Text('Sin gestiones para listar'),
                    )
                    : ListView.separated(
                      itemCount: soportegponService.soportegpon.length,
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              _showModalBottomSheet(context, soportegponService.soportegpon[index]);
                            },
                            leading: Icon(
                              (soportegponService.soportegpon[index].respuestaSoporte == null) ? null :
                              (soportegponService.soportegpon[index].respuestaSoporte == 'Finalizado') ? Icons.check_circle_outline_rounded : 
                              Icons.cancel_outlined,
                              
                              size: mq.width*0.10,
                              color: (soportegponService.soportegpon[index].respuestaSoporte == null) ? null :
                              (soportegponService.soportegpon[index].respuestaSoporte == 'Finalizado') ? greenColor : 
                              redColor,
                              /* shadows: const [
                                BoxShadow(
                                  color: Colors.black26,
                            ...
                            title: Text(
                              soportegponService.soportegpon[index].tarea,
                            ...
                            subtitle: Text(
                              DateFormat('yyyy-MM-dd HH:mm:ss').format(soportegponService.soportegpon[index].fechaSolicitudFirebase),
                              textAlign: TextAlign.left,
                              style: TextStyle(
                            ...
                            trailing: Container(
                              ...
                              child: Text(
                                soportegponService.soportegpon[index].statusSoporte == '0' ? 'Pendiente' : 'Atendido',
                                style: TextStyle(
                                  color: soportegponService.soportegpon[index].statusSoporte == '0' ? greyColor : blueColor,
      ...
      floatingActionButton: FloatingActionButton.small(
        onPressed: () async {
          ...
          final resp = await soportegponService.getSoporteGponByUser();
  ...
  void _showModalBottomSheet(BuildContext context, SoporteGpon data) {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const Text('Tarea:', style: TextStyle(fontWeight: FontWeight.bold)),
                    Text(data.tarea)
                  ],
                ),
                Row(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text((data.respuestaSoporte == null) ? '' : data.respuestaSoporte!)
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    Text(DateFormat('yyyy-MM-dd HH:mm:ss').format(data.fechaSolicitudFirebase))
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    Text((data.fechaRespuesta == '') ? '' : DateFormat('yyyy-MM-dd HH:mm:ss').format(data.fechaRespuesta))
                  ],
                ),
