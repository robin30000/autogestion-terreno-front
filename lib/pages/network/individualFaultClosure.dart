...
//const kGoogleApiKey = 'AIzaSyCAvtJpUmHTh9mAnTxl7ueCrietdNERAro';

class IndividualFaultClosurePage extends StatefulWidget {
  const IndividualFaultClosurePage({super.key});

  @override
  _IndividualFaultClosurePageState createState() =>
      _IndividualFaultClosurePageState();
}

class _IndividualFaultClosurePageState
    extends State<IndividualFaultClosurePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cierre Individual de Tickets'),
      ),
      body: Padding(
                ...
                child: CustomButton(
                  ...
                  function: networkservice.isLoading
                      ...
                      : () async {
                          ...
                          String _clasificador = 'cierre_individual';
