...
class ListIndividualPage extends StatefulWidget {
  const ListIndividualPage({super.key});

  @override
  State<ListIndividualPage> createState() => _ListIndividualPageState();
}

class _ListIndividualPageState extends State<ListIndividualPage> {
  @override
