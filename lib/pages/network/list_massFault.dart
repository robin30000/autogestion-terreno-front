...
class ListMassFaultPage extends StatefulWidget {
  const ListMassFaultPage({super.key});

  @override
  State<ListMassFaultPage> createState() => _ListContingenciaPageState();
}

class _ListContingenciaPageState extends State<ListMassFaultPage> {
  @override
  Widget build(BuildContext context) {
    ...
    //contingenciasService.getContingenciasByUser();
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: contingenciasService.contingencias.isEmpty
                              ...
                              : ListView.separated(
                                  itemCount:
                                      contingenciasService.contingencias.length,
                                  separatorBuilder:
                                  ...
                                  itemBuilder:
                                    ...
                                    return Container(
                                      ...
                                      child: ListTile(
                                        ...
                                        leading: Icon(
                                          (contingenciasService.contingencias[index].engestion ==
                                                      '0' &&
                                                  contingenciasService
                                                          .contingencias[index]
                                                          .finalizado ==
  ...
  void _showModalBottomSheet(BuildContext context, Registros data) {
                ...
                Row(
                  ...
                  children: [
                    const Text('Tipificación:',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Text((data.tipificacion == null)
                        ? ''
                        : (data.tipificacion == 'Ok')
                            ? 'Finalizado'
                            : 'Rechazado')
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    const Text('Fecha Respuesta:',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    Text((data.horacontingencia == '')
                        ? ''
                        : DateFormat('yyyy-MM-dd HH:mm:ss')
                            .format(data.horacontingencia))
                  ],
                ),
                SizedBox(
                  height: mq.height * 0.03,
