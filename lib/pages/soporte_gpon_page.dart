...
class _SoporteGponPageState extends State<SoporteGponPage> {
  ...
  void dispose() {
    ...
    if (_formKeySoporteGpon.currentState != null) _formKeySoporteGpon.currentState!.dispose();
    super.dispose();
  }
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      CustomField(controller: tareaController, hintText: 'Tarea*', icon: Icons.description_outlined),
                      
                      SizedBox(height: mq.height * 0.02,),

                      CustomField(controller: arponController, hintText: 'Apon*', icon: Icons.device_hub_outlined, maxlength: 6, keyboardType: TextInputType.number),
                      
                      SizedBox(height: mq.height * 0.02,),

                      CustomField(controller: napController, hintText: 'NAP*', icon: Icons.lan, maxlength: 2, keyboardType: TextInputType.number),
                      
                      SizedBox(height: mq.height * 0.02,),

                      CustomField(controller: hiloController, hintText: 'Hilo*', icon: Icons.power_input_outlined, maxlength: 2, keyboardType: TextInputType.number),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              CustomCheckBox(isSelected: internetPort1, label: '1', onChanged: (bool? newValue) => setState(() => internetPort1 = newValue!)),
                              CustomCheckBox(isSelected: internetPort2, label: '2', onChanged: (bool? newValue) => setState(() => internetPort2 = newValue!)),
                              CustomCheckBox(isSelected: internetPort3, label: '3', onChanged: (bool? newValue) => setState(() => internetPort3 = newValue!)),
                              CustomCheckBox(isSelected: internetPort4, label: '4', onChanged: (bool? newValue) => setState(() => internetPort4 = newValue!)),
                            ],
                          ),
                        ],
                      ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              CustomCheckBox(isSelected: tvPort1, label: '1', onChanged: (bool? newValue) => setState(() => tvPort1 = newValue!)),
                              CustomCheckBox(isSelected: tvPort2, label: '2', onChanged: (bool? newValue) => setState(() => tvPort2 = newValue!)),
                              CustomCheckBox(isSelected: tvPort3, label: '3', onChanged: (bool? newValue) => setState(() => tvPort3 = newValue!)),
                              CustomCheckBox(isSelected: tvPort4, label: '4', onChanged: (bool? newValue) => setState(() => tvPort4 = newValue!)),
                            ],
                          ),
                        ],
                      ),

                      CustomField(controller: contactoController, hintText: 'Contacto*', icon: Icons.phone, keyboardType: TextInputType.number),
                      
                      SizedBox(height: mq.height * 0.02,),

                      CustomField(controller: nombreContactoController, hintText: 'Nombre Contacto*', icon: Icons.person),
                      ...
                      CustomButton(
                        mq: mq, 
                        function: soportegponService.isLoading ? null : () async {
                          ...
                          String strInternetPort1 = (internetPort1) ? '1' : '0';
                          String strInternetPort2 = (internetPort2) ? '1' : '0';
                          String strInternetPort3 = (internetPort3) ? '1' : '0';
                          String strInternetPort4 = (internetPort4) ? '1' : '0';
                          String strTvPort1 = (tvPort1) ? '1' : '0';
                          String strTvPort2 = (tvPort2) ? '1' : '0';
                          String strTvPort3 = (tvPort3) ? '1' : '0';
                          String strTvPort4 = (tvPort4) ? '1' : '0';

                          final Map? resp = await soportegponService.postContingencia(
                          ...
                          if (resp!['type'] == 'error') {
                            ...
                            CustomShowDialog.alert(context: context, title: 'Excelente', message: resp['message']);
                        ...
                        text: soportegponService.isLoading ? 'Cargando...' : 'Enviar Solicitud',
                        height: 0.05,
                      ),
