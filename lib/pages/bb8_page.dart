            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      CustomField(controller: ciudadController, hintText: 'Ciudad*', icon: Icons.location_city_outlined),
                      SizedBox(height: mq.height * 0.02,),
                      CustomField(controller: direccionController, hintText: 'Dirección*', icon: Icons.signpost_outlined),
                      SizedBox(height: mq.height * 0.02,),
                      CustomButton(
                        mq: mq, 
                        function: bb8Service.isLoading ? null : () async {
                          ...
                          final resp = await bb8Service.getBB8(ciudad: ciudadController.text, direccion: direccionController.text);
                ...
                data.isEmpty
                ? bb8Res == '' ? Container() : Center(child: Text(bb8Res),)
                : SizedBox(
                  width: mq.width * 0.95,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  data[index].television == null ? const SizedBox() : Icon(
                                    Icons.tv_rounded,
                                    color: data[index].television!.split('|')[1] == 'Activo' ? greenColor : greyColor,
                                  ),
                                  data[index].internet == null ? const SizedBox() : Icon(
                                    Icons.wifi,
                                    color: data[index].internet!.split('|')[1] == 'Activo' ? greenColor : greyColor,
                                  ),
                                  data[index].telefonia == null ? const SizedBox() : Icon(
                                    Icons.phone,
                                    color: data[index].telefonia!.split('|')[1] == 'Activo' ? greenColor : greyColor,
                                  ),
                                ]
                              ),
                            )
