    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.only(top: widget.paddingTop, bottom: widget.paddingBottom, left: widget.paddingLeft, right: widget.paddingRight),
          ...
          suffixIcon: (!widget.isObscureText) ? null : Padding(
            padding: const EdgeInsetsDirectional.all(1),
            child: InkWell(
              onTap: () {
                setState(() {
              ...
              child: (_isVisible) ? const Icon(Icons.visibility_rounded) : const Icon(Icons.visibility_off_rounded),
            ) ,
          ),
