  ...
  Widget build(BuildContext context) {
    return TextFieldTags(
      ...
      inputfieldBuilder: (context, tec, fn, error, onChanged, onSubmitted) {
        return (
          (context, sc, tags, onTagDelete) {
            return Container(
              width: widget.mq.width * widget.width,
              height: widget.height == null ? null : widget.mq.height * widget.height,
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  contentPadding: const EdgeInsets.only(top: 1, bottom: 1, left: 20, right: 5),
                  ...
                  errorText: error,
                  prefixIconConstraints: BoxConstraints(maxWidth: widget.mq.width * 0.7),
